...
<?php 
if (is_single()){echo '<script type="text/javascript" src="//assets.pinterest.com/js/pinit.js"></script>';}else{}
wp_footer();?>
</body>
</html>